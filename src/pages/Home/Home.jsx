...
export default function Home() {
  return (
    <div className="bg-primary relative">
      <Navbar />
      <div className="max-w-screen-2xl mx-auto p-10 lg:p-36 md:p-20 flex flex-col md:flex-row-reverse items-center">
        <img
          src={circle}
          alt="circle"
        ...
        <div className="z-10 md:w-1/2">
          <img
            className="md:ml-auto md:mx-0 w-3/4 mx-auto mb-10 md:mb-0"
            src={babyImage}
            alt="baby"
          />
        </div>
        <div className="md:w-1/2 text-white z-10 text-center md:text-left">
          ...
          <h1 className="font-bold text-5xl md:text-8xl text-pink-400">
            ToyGalaxy
          </h1>
