  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto">
        <img className="w-3/4 mx-auto" src={errorImage} alt="error" />
        <div className="text-center md:absolute md:top-20 md:left-1/2 md:transform md:-translate-x-1/2">
